...
describe('bugs', function() {
  ...
  it('multiable form has same name field', function() {
    $('<form id="test-form"><input name="email" id="email" /></form>').appendTo(document.body);
    $('<form id="test-form2"><input name="email" id="email" /></form>').appendTo(document.body);
  ...
  it('query item error', function() {
    $('<form id="test-form"><input name="email" id="email" /></form>').appendTo(document.body);
    $('<form id="test-form2"><input name="email" id="email" /><input name="password" id="password" /></form>').appendTo(document.body);
    validator = new Validator({
      element: '#test-form'
    });
    validator.addItem({
