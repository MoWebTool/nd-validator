...
describe('utils.isHidden()', function() {
  ...
  it('select', function() {
    elem = $('<select style="display: none;"><option>1</option><option>2</option></select>').appendTo(document.body);
  ...
  it('visibility: hidden', function() {
    elem = $('<div style="display: none;width:40px;height:40px;"></div>').appendTo(document.body);
    expect(Utils.isHidden(elem)).to.be(true);
    elem.show();
    expect(Utils.isHidden(elem)).to.be(false);
  ...
  it('input hidden', function() {
    elem = $('<input type="hidden" name="test" value="0" />').appendTo(document.body);
    expect(Utils.isHidden(elem)).to.be(true);
    elem.show();
    expect(Utils.isHidden(elem)).to.be(true);
  });
  ...
  it('table', function() {
    elem = $('<table style="display: none;"><tbody><tr id="row"><td></td></tr></tbody></table>').appendTo(document.body);
    expect(Utils.isHidden(elem)).to.be(true);
    elem.show();
  ...
  it('tr', function() {
    elem = $('<table style="display: none;"><tbody><tr id="row" style="display: none;"><td></td></tr></tbody></table>').appendTo(document.body);
  ...
  it('div width/height: 0', function() {
    elem = $('<div style="width:0;height:0;overflow: hidden;"></div>').appendTo(document.body);
